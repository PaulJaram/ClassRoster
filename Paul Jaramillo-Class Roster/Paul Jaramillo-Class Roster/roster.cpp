...
void Roster::printAll()
{
	...
	{
		cout << classRosterArray[i]->getID(); cout << '/t';
		cout << classRosterArray[i]->getFirstName(); cout << '/t';
		cout << classRosterArray[i]->getLastName(); cout << '/t';
		cout << classRosterArray[i]->getEmail(); cout << '/t';
		cout << classRosterArray[i]->getAge(); cout << '/t';
		cout << classRosterArray[i]->getNumDays(); cout << '/t';
		cout << classRosterArray[i]->getDegree(); cout << endl;
	}
}
void Roster::printByDegree(DegreeProgram degree)
{
	for (int i = 0; i < numStudents; i++)
	{
		if (degree == classRosterArray[i]->getDegree())
		{
			...
			cout << classRosterArray[i]->getEmail(); cout << '/t';
			cout << classRosterArray[i]->getAge(); cout << '/t';
			cout << classRosterArray[i]->getNumDays(); cout << endl;

		}
		else; { cout << "No students in degree chosen"; }
		cout << endl;
